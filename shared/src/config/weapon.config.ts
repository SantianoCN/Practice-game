...
export const ICE_BALL: ProjectileStats = { radius: 15, damage: 6, range: 350, speed: 250, visualId: 'blue_ball' };
...
export const STAFF: WeaponStats = { cooldownMs: 200, manaCost: 10, projectile: FIREBALL, visualId: 'fire_staff' };
