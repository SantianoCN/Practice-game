...
export const ROOM_TEMPLATES: RoomTemplate[] = [
    ...
    },
    {
        ...
        chests: [
            { gridX: 19, gridY: 14, items: ["gold", "potion"] }
        ]
    },
    {
        id: "layout_7",
        ...
        chests: [
            { gridX: 8, gridY: 8, items: ["weapon"] },
            { gridX: 31, gridY: 21, items: ["gold"] }
        ]
    },
    {
        id: "layout_8",
        ...
        chests: [
            { gridX: 32, gridY: 7, items: ["weapon", "armor"] },
            { gridX: 7, gridY: 24, items: ["gold", "potion"] }
        ]
    },
    {
        id: "layout_9",
        ...
        chests: [
            { gridX: 19, gridY: 4, items: ["legendary_weapon", "gold_large"] }
        ]
    },
    {
        id: "layout_10",
        ...
        chests: [
            { gridX: 19, gridY: 14, items: ["relic", "gold"] }
        ]
    }
];