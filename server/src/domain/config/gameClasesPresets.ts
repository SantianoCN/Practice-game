import { ProjectileConfig, WeaponConfig, StartingWeaponPreset } from './WeaponConfigs';
import { EntityStats } from './EntityConfig';
...
export const STAFF: WeaponConfig = { cooldownMs: 2000, projectile: FIREBALL, sprite: 'fire_staff' };
